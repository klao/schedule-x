(function (global, factory) {
  ...
  class CalendarEventImpl {
      constructor(_config, id, start, end, title, people, location, description, calendarId, _options = undefined, _foreignProperties = {}) {
  ...
  class CalendarEventBuilder {
      ...
      build() {
          return new CalendarEventImpl(this._config, this.id, this.start, this.end, this.title, this.people, this.location, this.description, this.calendarId, this._options, this._foreignProperties);
      }
      withTitle(title) {
          this.title = title;
          return this;
  ...
  function CalendarHeader() {
      ...
      return (jsxRuntime.jsxs("header", { className: 'sx__calendar-header', children: [jsxRuntime.jsxs("div", { className: 'sx__calendar-header-content', children: [headerContentLeftPrependId && (jsxRuntime.jsx("div", { "data-ccid": headerContentLeftPrependId })), jsxRuntime.jsx(TodayButton, {}), jsxRuntime.jsx(ForwardBackwardNavigation, {}), jsxRuntime.jsx(RangeHeading, {}), headerContentLeftAppendId && (jsxRuntime.jsx("div", { "data-ccid": headerContentLeftAppendId }))] }), jsxRuntime.jsxs("div", { className: 'sx__calendar-header-content', children: [headerContentRightPrependId && (jsxRuntime.jsx("div", { "data-ccid": headerContentRightPrependId })), jsxRuntime.jsx(ViewSelection, {}), jsxRuntime.jsx(AppWrapper, { "$app": datePickerAppSingleton }), headerContentRightAppendId && (jsxRuntime.jsx("div", { "data-ccid": headerContentRightAppendId }))] })] }));
  }
  ...
  const beforeInitPlugins = ($app) => {
      Object.values($app.config.plugins).forEach((plugin) => {
          if (plugin === null || plugin === void 0 ? void 0 : plugin.beforeInit)
  ...
  const createCalendarState = (calendarConfig, timeUnitsImpl, selectedDate) => {
      var _a;
      const _view = signals.signal(((_a = calendarConfig.views.find((view) => view.name === calendarConfig.defaultView)) === null || _a === void 0 ? void 0 : _a.name) || calendarConfig.views[0].name);
      ...
      const setRange = (date) => {
          var _a, _b;
          const selectedView = calendarConfig.views.find((availableView) => availableView.name === _view.value);
  ...
  function TimeGridEvent({ calendarEvent, dayBoundariesDateTime, isCopy, setMouseDown, }) {
      ...
      const leftRule = getLeftRule(calendarEvent, $app.config.weekOptions.eventWidth);
  ...
  function TimeAxis() {
      ...
      const formatter = new Intl.DateTimeFormat($app.config.locale, $app.config.weekOptions.timeAxisFormatOptions);
  ...
  function DateAxis({ week }) {
      ...
      return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsx("div", { className: "sx__week-grid__date-axis", children: week.map((date) => (jsxRuntime.jsxs("div", { className: getClassNames(date), "data-date": toDateString$1(date), children: [jsxRuntime.jsx("div", { className: "sx__week-grid__day-name", children: getDayNameShort(date, $app.config.locale) }), jsxRuntime.jsx("div", { className: "sx__week-grid__date-number", children: date.getDate() })] }))) }) }));
  }
  ...
  function DateGridEvent({ calendarEvent, gridRow, isCopy, }) {
      ...
      return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsxs("div", { id: isCopy ? getTimeGridEventCopyElementId(calendarEvent.id) : undefined, tabIndex: 0, "aria-label": calendarEvent.title +
                  ...
                  }, children: [!customComponent && (jsxRuntime.jsxs(preact.Fragment, { children: [hasOverflowLeft && (jsxRuntime.jsx("div", { className: 'sx__date-grid-event--left-overflow', style: overflowStyles })), jsxRuntime.jsx("span", { className: "sx__date-grid-event-text", children: calendarEvent.title }), hasOverflowRight && (jsxRuntime.jsx("div", { className: 'sx__date-grid-event--right-overflow', style: overflowStyles }))] })), $app.config.plugins.resize &&
                          !((_b = calendarEvent._options) === null || _b === void 0 ? void 0 : _b.disableResize) &&
  ...
  function MonthGridEvent({ gridRow, calendarEvent, date, isFirstWeek, isLastWeek, }) {
      ...
      return (jsxRuntime.jsx("div", { draggable: !!$app.config.plugins.dragAndDrop, "data-event-id": calendarEvent.id, "data-ccid": customComponentId, onMouseDown: (e) => createDragStartTimeout(handleStartDrag, e), onMouseUp: (e) => setClickedEventIfNotDragging(calendarEvent, e), onTouchStart: (e) => createDragStartTimeout(handleStartDrag, e), onTouchEnd: (e) => setClickedEventIfNotDragging(calendarEvent, e), onClick: handleOnClick, onKeyDown: handleKeyDown, className: classNames.join(' '), style: {
              ...
              backgroundColor: customComponent
                  ? undefined
                  : eventCSSVariables.backgroundColor,
          }, tabIndex: 0, role: "button", children: !customComponent && (jsxRuntime.jsx("div", { className: "sx__month-grid-event-title", children: calendarEvent.title })) }));
  }
  ...
  function MonthGridDay({ day, isFirstWeek, isLastWeek }) {
      ...
      return (jsxRuntime.jsxs("div", { className: wrapperClasses.join(' '), "data-date": day.date, onClick: () => $app.config.callbacks.onClickDate &&
              $app.config.callbacks.onClickDate(day.date), "aria-label": getLocalizedDate(day.date, $app.config.locale), onDblClick: () => { var _a, _b; return (_b = (_a = $app.config.callbacks).onDoubleClickDate) === null || _b === void 0 ? void 0 : _b.call(_a, day.date); }, children: [jsxRuntime.jsxs("div", { className: "sx__month-grid-day__header", children: [isFirstWeek ? (jsxRuntime.jsx("div", { className: "sx__month-grid-day__header-day-name", children: getDayNameShort(dayDate, $app.config.locale) })) : null, jsxRuntime.jsx("div", { className: dateClassNames.join(' '), children: dayDate.getDate() })] }), jsxRuntime.jsx("div", { className: "sx__month-grid-day__events", children: Object.values(day.events)
  ...
  function MonthAgendaEvent({ calendarEvent }) {
      ...
      return (jsxRuntime.jsx("div", { className: "sx__event sx__month-agenda-event", "data-ccid": customComponentId, "data-event-id": calendarEvent.id, style: {
              ...
              borderLeft: customComponent ? undefined : eventCSSVariables.borderLeft,
              padding: customComponent ? '0px' : undefined,
          }, onClick: (e) => onClick(e), onKeyDown: onKeyDown, tabIndex: 0, role: "button", children: !customComponent && (jsxRuntime.jsxs(preact.Fragment, { children: [jsxRuntime.jsx("div", { className: "sx__month-agenda-event__title", children: calendarEvent.title }), jsxRuntime.jsxs("div", { className: "sx__month-agenda-event__time sx__month-agenda-event__has-icon", children: [jsxRuntime.jsx(TimeIcon, { strokeColor: `var(--sx-color-on-${calendarEvent._color}-container)` }), getTimeStamp(calendarEvent, $app.config.locale)] })] })) }));
  }
